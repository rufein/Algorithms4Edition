 ...
 *
 *   Compilation:  javac BinarySearchSTcaching.java
 *   Execution:    java BinarySearchSTcaching < tiny.txt
 * 
...
public class BinarySearchSTcaching<Key extends Comparable<Key>, Value> {
    ...
    public BinarySearchSTcaching() { this(INIT_CAPACITY); }   

    // create an empty symbol table with given initial capacity
    public BinarySearchSTcaching(int capacity) { 
    ...
    public Value get(Key key) {
        if(keys[cache].compareTo(key) == 0) return vals[cache]; // Cache implementation <------------------------------
        if (isEmpty()) return null;
        int i = rank(key); 
        if (i < N && keys[i].compareTo(key) == 0) { cache = i; return vals[i];}
        return null;
    } 
    ...
    *****************************************************************************/
    public static void main(String[] args) { 
        BinarySearchSTcaching<String, Integer> st = new BinarySearchSTcaching<String, Integer>();
