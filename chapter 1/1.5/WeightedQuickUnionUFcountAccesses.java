 ...
 *
 *   Compilation:  javac WeightedQuickUnionUFcountAccesses.java
 *   Execution:    java WeightedQuickUnionUFcountAccesses < tinyUF.txt
 *                
 * 
...
public class WeightedQuickUnionUFcountAccesses {
     ...
     */
    public WeightedQuickUnionUFcountAccesses(int N) {
        count = N;
        id = new int[N];
        sz = new int[N];
        accesses = 0;
    ...
    */
    ...
    public static void main(String[] args)  { 
        int N = StdIn.readInt();
        WeightedQuickUnionUFcountAccesses uf = new WeightedQuickUnionUFcountAccesses(N);
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
